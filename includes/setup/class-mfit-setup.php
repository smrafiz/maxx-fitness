...
class Mfit_Setup {
	...
	public function register() {
		...
		$this->header_args = array(
			'default-image' => array(
				...
				'description'   => esc_html__( 'Default Header Image', 'maxx-fitness' ),
			),
		);
	...
	public function theme_setup_core() {
		 ...
		 * If you're building a theme based on Mfit Theme, use a find and replace
		 * to change 'maxx-fitness' to the name of your theme in all the template files.
		 */
