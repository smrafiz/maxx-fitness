...
class Mfit_Customizer {
	...
	private function get_classes() {
		$classes = array(
			Mfit_Customizer_Panels::class,
			Mfit_Customizer_Sections::class,
			Mfit_Customizer_Controls::class,
		);
	...
	public function modify_controls( $wp_customize ) {
		...
		$wp_customize->get_section( 'background_image' )->title = esc_html__( 'Site Background', 'maxx-fitness' );
		$wp_customize->get_section( 'title_tagline' )->title    = esc_html__( 'Logo / Title / Favicon', 'maxx-fitness' );
		$wp_customize->get_section( 'title_tagline' )->priority = 8;
		$wp_customize->get_section( 'header_image' )->title     = esc_html__( 'Header Background', 'maxx-fitness' );
		...
		$wp_customize->get_control( 'custom_logo' )->description = esc_html__( 'Recommended image size is 180x180 px.', 'maxx-fitness' );
